...
/***
 * for such cases, these @Provides are redundant and we case use @Bind to
 ...
 * 3. Binds method will have only one constructor argument and since Dagger never creates the implementaion of this class so we can't use
